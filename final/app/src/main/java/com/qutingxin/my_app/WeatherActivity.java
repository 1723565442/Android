...
import com.qutingxin.my_app.Adapter.WeatherAdapter;
import com.qutingxin.my_app.Bean.Weather_bean;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    private void addWeather() {
        Weather_bean now = new Weather_bean("现在", R.drawable.cloudy);
        weatherList.add(now);
        int wea[] = {R.drawable.rainy, R.drawable.cloudy};
        for (int i = 1; i < 12; i++) {
            Weather_bean last = new Weather_bean(i + "时", wea[i%2]);
